...
static const struct TrainerMon sParty_CamperLiam[] = {
    {
        .iv = TRAINER_PARTY_IVS(9, 10, 10, 5, 5, 6),
        .lvl = 13,
        .species = SPECIES_GEODUDE,
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
        .moves = {MOVE_TACKLE, MOVE_ROCK_THROW, MOVE_DEFENSE_CURL, MOVE_NONE},
        .heldItem = ITEM_NONE,
        .ev = TRAINER_PARTY_EVS(20, 30, 20, 0, 10, 0),
    },
    {
        .iv = TRAINER_PARTY_IVS(10, 11, 10, 5, 5, 7),
        .lvl = 14,
        .species = SPECIES_ONIX,
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
        .moves = {MOVE_BIND, MOVE_ROCK_THROW, MOVE_TACKLE, MOVE_NONE},
        .heldItem = ITEM_NONE,
        .ev = TRAINER_PARTY_EVS(30, 20, 30, 0, 10, 0),
    },
    {
        .iv = TRAINER_PARTY_IVS(9, 11, 9, 5, 5, 6),
        .lvl = 13,
        .species = SPECIES_SANDSHREW,
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
        .moves = {MOVE_SCRATCH, MOVE_SAND_ATTACK, MOVE_ROLLOUT, MOVE_NONE},
        .heldItem = ITEM_NONE,
        .ev = TRAINER_PARTY_EVS(20, 30, 20, 0, 10, 0),
    },
    {
        .iv = TRAINER_PARTY_IVS(10, 10, 10, 5, 5, 6),
        .lvl = 14,
        .species = SPECIES_LARVITAR,
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
        .moves = {MOVE_SAND_ATTACK, MOVE_BITE, MOVE_SANDSTORM, MOVE_ROCK_THROW},
        .heldItem = ITEM_NONE,
        .ev = TRAINER_PARTY_EVS(25, 25, 25, 0, 10, 0),
    },
    {
        .iv = TRAINER_PARTY_IVS(9, 10, 9, 5, 5, 6),
        .lvl = 14,
        .species = SPECIES_NUMEL, // Nusget
        .nature = TRAINER_PARTY_NATURE(NATURE_MODEST),
        .moves = {MOVE_EMBER, MOVE_GROWL, MOVE_ROLLOUT, MOVE_NONE},
        .heldItem = ITEM_NONE,
        .ev = TRAINER_PARTY_EVS(20, 10, 20, 20, 10, 0),
    },
    {
        .iv = TRAINER_PARTY_IVS(10, 10, 10, 5, 5, 7),
        .lvl = 13,
        .species = SPECIES_SHROOMISH, // Mogelbaum
        .nature = TRAINER_PARTY_NATURE(NATURE_BOLD),
        .moves = {MOVE_LEECH_SEED, MOVE_TACKLE, MOVE_STUN_SPORE, MOVE_NONE},
        .heldItem = ITEM_NONE,
        .ev = TRAINER_PARTY_EVS(20, 10, 20, 0, 30, 0),
    },
};

static const struct TrainerMon sParty_CamperRocky[] = {
    {
        .iv = TRAINER_PARTY_IVS(10, 12, 10, 5, 5, 8),
        .lvl = 14,
        .species = SPECIES_ONIX,
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
        .moves = {MOVE_TACKLE, MOVE_ROCK_THROW, MOVE_BIND, MOVE_NONE},
        .heldItem = ITEM_NONE,
        .ev = TRAINER_PARTY_EVS(30, 20, 30, 0, 10, 0),
    },
    {
        .iv = TRAINER_PARTY_IVS(8, 10, 10, 5, 5, 6),
        .lvl = 13,
        .species = SPECIES_GEODUDE,
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
        .moves = {MOVE_TACKLE, MOVE_ROCK_THROW, MOVE_SMOKESCREEN, MOVE_NONE},
        .heldItem = ITEM_NONE,
        .ev = TRAINER_PARTY_EVS(20, 30, 20, 0, 10, 0),
    },
    {
        ...
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
        .moves = {MOVE_WATER_GUN, MOVE_ROCK_THROW, MOVE_SAND_ATTACK, MOVE_NONE},
        .heldItem = ITEM_NONE,
        .ev = TRAINER_PARTY_EVS(20, 30, 20, 0, 20, 0),
    },
    {
        .iv = TRAINER_PARTY_IVS(10, 10, 10, 5, 5, 6),
        .lvl = 13,
        .species = SPECIES_SLUGMA,
        .nature = TRAINER_PARTY_NATURE(NATURE_MODEST),
        .moves = {MOVE_EMBER, MOVE_SMOKESCREEN, MOVE_ROCK_THROW, MOVE_NONE},
        .heldItem = ITEM_NONE,
        .ev = TRAINER_PARTY_EVS(10, 0, 20, 30, 10, 0),
    },
    {
        .iv = TRAINER_PARTY_IVS(11, 10, 10, 5, 5, 8),
        .lvl = 14,
        .species = SPECIES_OMANYTE,
        .nature = TRAINER_PARTY_NATURE(NATURE_MODEST),
        .moves = {MOVE_WATER_GUN, MOVE_ROCK_THROW, MOVE_BITE, MOVE_NONE},
        .heldItem = ITEM_NONE,
        .ev = TRAINER_PARTY_EVS(10, 0, 20, 30, 20, 0),
    },
    {
        .iv = TRAINER_PARTY_IVS(9, 11, 10, 5, 5, 7),
        .lvl = 13,
        .species = SPECIES_GEODUDE,
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
        .moves = {MOVE_TACKLE, MOVE_ROCK_THROW, MOVE_DEFENSE_CURL, MOVE_NONE},
...
static const struct TrainerMon sParty_LeaderBrock[] = {
    {
        ...
        .species = SPECIES_LARVITAR,
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
        .moves = {MOVE_TACKLE, MOVE_ROCK_THROW, MOVE_SAND_ATTACK, MOVE_SANDSTORM},
        .heldItem = ITEM_ORAN_BERRY,
    },
    {
        .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
        .ev = TRAINER_PARTY_EVS(10, 15, 10, 0, 0, 0),
        .lvl = 14,
        .species = SPECIES_GEODUDE,
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
        .moves = {MOVE_TACKLE, MOVE_ROCK_THROW, MOVE_DEFENSE_CURL, MOVE_ROCK_TOMB},
        .heldItem = ITEM_ORAN_BERRY,
    },
    {
        .iv = TRAINER_PARTY_IVS(13, 12, 12, 12, 12, 13),
        .ev = TRAINER_PARTY_EVS(10, 0, 10, 15, 0, 0),
        .lvl = 14,
        .species = SPECIES_OMANYTE,
        .nature = TRAINER_PARTY_NATURE(NATURE_MODEST),
        .moves = {MOVE_WATER_GUN, MOVE_ROCK_THROW, MOVE_WITHDRAW, MOVE_ICE_BEAM},
        .heldItem = ITEM_SITRUS_BERRY,
    },
    {
        .iv = TRAINER_PARTY_IVS(12, 13, 12, 12, 12, 12),
        .ev = TRAINER_PARTY_EVS(10, 15, 10, 0, 0, 0),
        .lvl = 14,
        .species = SPECIES_KABUTO,
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
        .moves = {MOVE_WATER_GUN, MOVE_ROCK_THROW, MOVE_WATER_PULSE, MOVE_ROCK_TOMB},
        .heldItem = ITEM_ORAN_BERRY,
    },
    {
        .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
        ...
        .species = SPECIES_SLUGMA,
        .nature = TRAINER_PARTY_NATURE(NATURE_MODEST),
        .moves = {MOVE_EMBER, MOVE_ROLLOUT, MOVE_SMOKESCREEN, MOVE_POUND},
    ...
    },
    {
        ...
        .species = SPECIES_ONIX,
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
        .moves = {MOVE_ROCK_THROW, MOVE_BIND, MOVE_SCREECH, MOVE_IRON_TAIL},
        .ev = TRAINER_PARTY_EVS(20, 20, 15, 0, 0, 0),
        .heldItem = ITEM_QUICK_CLAW,
    },
}; //I hate Brock
