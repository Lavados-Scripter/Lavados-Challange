...
static const u16 sSquirtleLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_TACKLE), // 40
    LEVEL_UP_MOVE( 3, MOVE_WATER_GUN), // 40
    LEVEL_UP_MOVE( 5, MOVE_WITHDRAW),
    LEVEL_UP_MOVE( 7, MOVE_BUBBLE), // 40
    LEVEL_UP_MOVE( 9, MOVE_RAPID_SPIN), // 50
    LEVEL_UP_MOVE(11, MOVE_BITE), // 40
    LEVEL_UP_MOVE(13, MOVE_METAL_CLAW), // 50 ; + ATK
    LEVEL_UP_MOVE(15, MOVE_BUBBLE_BEAM), // 65
    LEVEL_UP_MOVE(17, MOVE_HEADBUTT), // 70
    LEVEL_UP_MOVE(19, MOVE_PROTECT),
    LEVEL_UP_MOVE(21, MOVE_RAIN_DANCE),
    LEVEL_UP_MOVE(23, MOVE_MIRROR_COAT),
    LEVEL_UP_MOVE(25, MOVE_ICY_WIND), // 55 ; - INIT
    LEVEL_UP_MOVE(27, MOVE_IRON_TAIL), // 100
    LEVEL_UP_MOVE(29, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(31, MOVE_COUNTER),
    LEVEL_UP_MOVE(33, MOVE_METEOR_MASH), // 90 ; + ATK
    LEVEL_UP_MOVE(35, MOVE_ICE_BEAM), // 95
    LEVEL_UP_MOVE(37, MOVE_HYDRO_PUMP), // 120
    LEVEL_UP_MOVE(39, MOVE_SKULL_BASH), // 130
    LEVEL_UP_END
};
...
static const u16 sMeowthLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH), // 40
    LEVEL_UP_MOVE( 1, MOVE_GROWL), // - ATK
    LEVEL_UP_MOVE( 5, MOVE_FURY_SWIPES), // 18 & 2-5 Attack
    LEVEL_UP_MOVE( 7, MOVE_BITE), // 60 & may flinch
    LEVEL_UP_MOVE(10, MOVE_PAY_DAY), // 40 & More Money
    LEVEL_UP_MOVE(12, MOVE_FAINT_ATTACK), // 60 & NO MISS
    LEVEL_UP_MOVE(15, MOVE_TAKE_DOWN), // 90 & SELF DMG
    LEVEL_UP_MOVE(18, MOVE_SCREECH), // -2 DEF
    LEVEL_UP_MOVE(22, MOVE_SWORDS_DANCE), // +2 ATK
    LEVEL_UP_MOVE(25, MOVE_DOUBLE_EDGE), // 120 & Self DMG
    LEVEL_UP_MOVE(28, MOVE_CRUNCH), // 80 & - DEF
    LEVEL_UP_MOVE(31, MOVE_BODY_SLAM), // 85 & Paralysis
    LEVEL_UP_MOVE(34, MOVE_FAKE_OUT), // 40 & prio & flinch
    LEVEL_UP_MOVE(37, MOVE_SWAGGER), // 90 & Ziel: (+2 ATK & verwirrt)
    LEVEL_UP_MOVE(40, MOVE_HYPER_BEAM), // 150
    LEVEL_UP_END
};
